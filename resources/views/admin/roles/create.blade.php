        ...
        <div class="col-md-12">
            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.roles.store') }}">
                    ...
                    <div class="form-group">
                        <button type="submit"  style="background-color: #0C6476 !important; color: white !important; border: none !important;" class="btn btn-primary"><i class="fa fa-plus"></i>@lang('site.create')</button>
                    </div>
