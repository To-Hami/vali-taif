                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('read_admins'))
                            <a href="{{ route('admin.admins.create') }}"   style="background-color: #0C6476 !important; color: white !important; border: none !important;" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif
                        ...
                        @if (auth()->user()->hasPermission('delete_admins'))
                            <form method="post" action="{{ route('admin.admins.bulk_delete') }}" style="display: inline-block;">
                                ...
                                <button type="submit" class="btn btn-danger"   style="background-color: #FF6162 !important; color: white !important; border: none !important;" id="bulk-delete" disabled="true"><i class="fa fa-trash"></i> @lang('site.bulk_delete')</button>
                            </form><!-- end of form -->
                        @endif
